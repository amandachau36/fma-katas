...
namespace ConferenceTrack.UnitTests.Business
{
    public class TrackManagerUnitTests
    {
        ...
        public void It_Should_Return_AListOfTalksThatFitIntoTheMorningSession_Given_AListOfTalks(List<Talk> talks, List<List<string>> expectedMorningSessions)
        {
            //arrange
             var morningSession = new MorningSession(new TimeSpan(9, 0, 0), new TimeSpan(12, 0, 0)); 
             var trackManager = new TrackManager(2, talks, morningSession);
